...
st.markdown("<h5 style='text-align: center;'>This Application predicts the best crop to plant based on NPK values and Weather Conditions!</h5>", unsafe_allow_html=True)
...
model_accuracy = accuracy_score(y_test, y_pred) * 100  # Accuracy in percentage
...
st.markdown("<h5 style='text-align: center;'>Model Accuracy:</h5>", unsafe_allow_html=True)
st.markdown(f"<h3 style='text-align: center; color: green;'>{model_accuracy:.2f}%</h3>", unsafe_allow_html=True)
...
if predict_btn:
    ...
    with colb:
        st.markdown(f"<h3 style='text-align: center;'>Best Crop to Plant: {rdf_predicted_value[0]}.</h3>", unsafe_allow_html=True)
